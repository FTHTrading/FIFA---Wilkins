  ...
  const venueAlerts = [
    {
      ...
      body: 'Shortest walking path from Vine City MARTA station to Gate 1. Follow the lit walkway.',
      bodyI18n: { es: 'Camino más corto desde la estación MARTA Vine City a la Puerta 1.', ar: 'أقصر طريق للمشي من محطة Vine City MARTA إلى البوابة 1.' },
      isActive: true,
    },
    {
      eventId: event.id,
      ...
      body: 'Expected high of 95°F. Free water stations at Gates 1, 3, 5, 7. Cooling zones in the Family Zone.',
      isActive: true,
    },
    {
      eventId: event.id,
      ...
      body: 'Prayer and meditation room at Gate 1, Level 1 is open continuously during event hours. Wudu facilities adjacent.',
      isActive: true,
    },
    {
      eventId: event.id,
      ...
      body: 'Free high-speed WiFi available throughout the stadium. SSID: FIFA2026-ATL. No password needed.',
      isActive: true,
    },
  ];
